/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/ban-types, @typescript-eslint/interface-name-prefix, @typescript-eslint/no-empty-interface */
